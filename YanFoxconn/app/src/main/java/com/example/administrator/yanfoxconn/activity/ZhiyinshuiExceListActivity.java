...
public class ZhiyinshuiExceListActivity extends BaseActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lvOption.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent = new Intent(ZhiyinshuiExceListActivity.this, ZhiyinshuiExceDetailActivity.class);
    ...
    private void getMessage(){
        ...
        if (type.equals("ZWCT")){
            url = Constants.HTTP_WATER_EXCE_VIEW_INFO_SERVLET + "?date="+nowDateTime+"&dim_id=" + dim_id + "&type=" + type + "&sc_id=";

        }else {
            url = Constants.HTTP_WATER_EXCE_VIEW_INFO_SERVLET + "?date=&dim_id=" + dim_id + "&type=" + type + "&sc_id=";
        }
        Log.e("-----------", "url==" + url);
        new Thread() {
            @Override
...
//                    finish();
                ...
                case MESSAGE_NETMISTAKE://Toast彈出
                    ToastUtils.showLong(ZhiyinshuiExceListActivity.this,R.string.net_mistake);
                    break;
                case MESSAGE_SET_TEXT://text賦值
                    if (exce_info!=null&&exce_info.size()!=0){
                        mZhiyinshuiExceListAdapter = new ZhiyinshuiExceListAdapter(ZhiyinshuiExceListActivity.this,exce_info);
