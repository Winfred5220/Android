...
import com.example.administrator.yanfoxconn.adapter.FolderAdapter;
import com.example.administrator.yanfoxconn.adapter.ImageGridAdapter;
import com.example.administrator.yanfoxconn.bean.Folder;
import com.example.administrator.yanfoxconn.bean.Image;
...
import com.example.administrator.yanfoxconn.widget.ImageConfig;
...
public class PhotoPickerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!FoxContext.getInstance().getTakePic().equals("W0")) {
//             首次加载所有图片
    ...
    private void createPopupFolderList(){
        ...
        int folderItemViewHeight =
                // 图片高度
                getResources().getDimensionPixelOffset(R.dimen.dimen_72) +
                // Padding Top
    ...
    private int getItemImageWidth(){
        ...
        int columnSpace = getResources().getDimensionPixelOffset(R.dimen.dimen_2);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(item.getItemId() == R.id.action_picker_done){//完成按鈕
            complete();
            return true;
        }
