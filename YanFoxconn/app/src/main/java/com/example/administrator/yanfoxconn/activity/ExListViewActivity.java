...
//    private AMapLocationClient locationClient = null;
    ...
    public String[][] gridViewType = {
            ...
            {"BG", "BP", "ZXS", "DN","DQ","DT","FH","GA","IG"},//總務
    ...
    public String[][] gridViewChild = {
            ...
            {"宿舍巡檢", "餐飲巡檢", "消殺巡檢", "宿舍查驗","直飲水","生活垃圾清運","餐廳巡檢","臨時工簽到","宿舍寄存"},//總務
    ...
    public int[][] img = {
            ...
            {R.mipmap.icon_sushe, R.mipmap.icon_canyin, R.mipmap.icon_xiaosha, R.mipmap.icon_sushe2,
                    R.mipmap.icon_zhiyinshui,R.mipmap.icon_laji, R.mipmap.icon_canting, R.mipmap.icon_linshi, R.mipmap.icon_linshi},//總務
