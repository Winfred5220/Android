 ...
 *
 */
public class ZhiyinshuiCheckActivity extends BaseActivity implements View.OnClickListener ,TimeDatePickerDialog.TimePickerDialogInterface{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_zhiyinshui_check);
    ...
    private void getMessage(){
        showDialog();
        final String url = Constants.HTTP_WATER_SCAN_SERVLET +"?flag=S"+"&dim_id="+dim_id+"&type="+type;
    ...
    private void check() {
        ...
        object.addProperty("dim_id", mMsgList.get(0).getDim_id());
        object.addProperty("type", mMsgList.get(0).getDIM_TYPE());
        object.addProperty("dim_locale", mMsgList.get(0).getDIM_AREA()+"-"+mMsgList.get(0).getDIM_BUILD()+"-"+mMsgList.get(0).getDIM_LAYER()+"-"+mMsgList.get(0).getDIM_POSITION());
            ...
            new Thread() {
                public void run() {
                    ...
                    try {
                        ...
                        FileUtil.deletePhotos(ZhiyinshuiCheckActivity.this);
                    }
                }
            }.start();
      }
...
//                    finish();
                ...
                case MESSAGE_NETMISTAKE://Toast彈出
                    ToastUtils.showLong(ZhiyinshuiCheckActivity.this,R.string.net_mistake);
                    break;
...
//                    ToastUtils.showLong(CrossScanActivity.this, msg.obj.toString());
                ...
                case MESSAGE_SET_CHECK://點檢項列表賦值
                    ...
                    if (mCheckMsgList != null) {
                        ...
                        mZhiyinshuiCheckAdapter = new ZhiyinshuiCheckAdapter(ZhiyinshuiCheckActivity.this,mCheckMsgList,isSelected);
                        rvOption.setAdapter(mZhiyinshuiCheckAdapter);
                    } else {
                        ToastUtils.showShort(ZhiyinshuiCheckActivity.this, "沒有數據!");
                    }
                    break;
                ...
                .setPositiveButton("確認", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        if (t==MESSAGE_TOAST){
                            ...
                            Intent intent = new Intent(ZhiyinshuiCheckActivity.this, ZhiyinshuiExceListActivity.class);
