...
public class SwipeListViewThree extends ListView {
    ...
    public SwipeListViewThree(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SwipeListViewThree(Context context, AttributeSet attrs, int defStyle) {
