...
public class CPCBodyListAdapter extends BaseAdapter {
    ...
    public CPCBodyListAdapter(Context context, HashMap<Integer, Boolean> isSelected, List<HubList> lists) {
    ...
    public static void setIsSelected(HashMap<Integer, Boolean> isSelected) {
        CPCBodyListAdapter.isSelected = isSelected;
    }
