...
public class ActEndActivity extends BaseActivity implements View.OnClickListener{
    ...
    LinearLayout ll_photo;//結束信息圖片LinearLayout
    ...
    protected void onCreate( Bundle savedInstanceState) {
        ...
        ActivityMsg activityMsg = (ActivityMsg) getIntent().getSerializableExtra("item");
        if (activityMsg!=null){
            ...
            tvStartTime.setText(activityMsg.getAct_time_start());
            tvEndSignDate.setText(activityMsg.getAct_end_sign());
